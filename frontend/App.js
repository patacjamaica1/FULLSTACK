...
const styles = StyleSheet.create({
  root:{flex:1,backgroundColor:"#f7f2ef",padding:20},
  dark:{backgroundColor:"#222"},
  rowBetween:{flexDirection:"row",justifyContent:"space-between",alignItems:"center"},
  h1:{fontSize:26,fontWeight:"bold",color:"#5a3e36"},
  addBox:{flexDirection:"row",marginTop:20},
  input:{flex:1,borderWidth:1,borderColor:"#c2a68d",borderRadius:6,padding:10,backgroundColor:"#fff"},
  inputDark:{backgroundColor:"#333",color:"#fff",borderColor:"#555"},
  addBtn:{backgroundColor:"#8b5e3c",paddingHorizontal:14,borderRadius:6,marginLeft:8,justifyContent:"center"},
  addTxt:{color:"#fff",fontWeight:"600"},
  filters:{flexDirection:"row",marginTop:16,justifyContent:"space-between"},
  fBtn:{flex:1,padding:10,backgroundColor:"#decab9",marginHorizontal:4,borderRadius:6},
  fActive:{backgroundColor:"#a9746e"},
  fTxt:{textAlign:"center",color:"#5a3e36"},
  fTxtA:{color:"#fff",fontWeight:"700"},

  /* TaskItem styles */
  row:{flexDirection:"row",alignItems:"center",backgroundColor:"#f2e1d9",
       marginVertical:6,borderRadius:8,padding:10},
  rowDark:{backgroundColor:"#444"},
  tText:{flex:1,marginHorizontal:10,fontSize:16,color:"#333"},
  tDark:{color:"#eee"},
  tDone:{textDecorationLine:"line-through",color:"#999"},
  tInput:{flex:1,borderBottomWidth:1,borderColor:"#aaa",marginHorizontal:10},
  tInputDark:{color:"#fff",borderColor:"#777"},
  tBtns:{flexDirection:"row",gap:10},
  tBtnTxt:{color:"#a0522d",fontWeight:"600"},
});
